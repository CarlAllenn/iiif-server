...
currently maintained by Carl Allen (the "Maintainer").

This Individual Contributor License Agreement ("Agreement") documents the
rights granted by contributors to the Maintainer. It is adapted from the
...
agreeing to it. This Agreement covers your past, present, and future
...
the Project. For the purposes of this definition, "submitted" means any form
of electronic, verbal, or written communication sent to the Maintainer or
its representatives, including but not limited to communication on
electronic mailing lists, source code control systems, and issue tracking
systems that are managed by, or on behalf of, the Maintainer for the purpose
of discussing and improving the Project, but excluding communication that is
...
For the avoidance of doubt, this grant includes the right to license Your
Contributions, and derivative works thereof, under any license terms the
Maintainer chooses, including licenses other than the Project's current
license (AGPL-3.0-only), including proprietary and commercial license terms.
The Project itself will always remain available under its open-source
license; this clause permits the Maintainer to additionally offer the
Project, including Your Contributions, under other terms.
...
submit it to the Maintainer separately from any Contribution, identifying
...
Agreement to this CLA is collected per contributor on their first pull
request via the CLA-assistant integration; the signature record lives with
that integration.
